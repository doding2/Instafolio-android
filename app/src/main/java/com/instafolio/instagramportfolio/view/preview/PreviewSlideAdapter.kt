...
import com.instafolio.instagramportfolio.databinding.ItemPreviewSlideInstarSizeBinding
import com.instafolio.instagramportfolio.databinding.ItemPreviewSlideInstarSizeBindingBinding
import com.instafolio.instagramportfolio.databinding.ItemPreviewSlideOriginalBinding
import com.instafolio.instagramportfolio.databinding.ItemPreviewSlideOriginalBindingBinding
        ...
        return when (viewType) {
            PreviewSlide.ORIGINAL -> {
                val binding: ItemPreviewSlideOriginalBinding =
                    DataBindingUtil.inflate(inflater, com.instafolio.instagramportfolio.R.layout.item_preview_slide_original, parent, false)
                OriginalViewHolder(binding)
            }
            PreviewSlide.INSTAR_SIZE -> {
                val binding: ItemPreviewSlideInstarSizeBinding =
                    DataBindingUtil.inflate(inflater, com.instafolio.instagramportfolio.R.layout.item_preview_slide_instar_size, parent, false)
                InstarSizeViewHolder(binding)
            }
            PreviewSlide.ORIGINAL_BINDING -> {
                val binding: ItemPreviewSlideOriginalBindingBinding =
                    DataBindingUtil.inflate(inflater, com.instafolio.instagramportfolio.R.layout.item_preview_slide_original_binding, parent, false)
                OriginalBindingViewHolder(binding)
            }
            PreviewSlide.INSTAR_SIZE_BINDING -> {
                val binding: ItemPreviewSlideInstarSizeBindingBinding =
                    DataBindingUtil.inflate(inflater, com.instafolio.instagramportfolio.R.layout.item_preview_slide_instar_size_binding, parent, false)
