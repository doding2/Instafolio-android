...
import com.instafolio.instagramportfolio.databinding.FragmentSlideBinding
import com.instafolio.instagramportfolio.extension.NoManageStoragePermissionException
import com.instafolio.instagramportfolio.extension.NoReadStoragePermissionException
import com.instafolio.instagramportfolio.extension.getBindingIndicesState
import com.instafolio.instagramportfolio.extension.getFileAsImages
import com.instafolio.instagramportfolio.extension.getFilePathFromURI
import com.instafolio.instagramportfolio.extension.getInstarSizeState
import com.instafolio.instagramportfolio.extension.getResized
import com.instafolio.instagramportfolio.extension.imageToBitmap
import com.instafolio.instagramportfolio.extension.optimizeDocumentCache
import com.instafolio.instagramportfolio.extension.pdfToBitmaps
import com.instafolio.instagramportfolio.extension.showAlertDialog
    ...
    private fun setPreviewWith(firstImage: Bitmap, secondImage: Bitmap) {
        binding.run {
            ...
            imageBindingPreviewFirst.post {
                ...
                binding.imageBindingPreviewFirst.alpha = 1f
                binding.imageBindingPreviewSecond.alpha = 1f
            }
        }
    }
